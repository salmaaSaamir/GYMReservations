...
namespace gym_reservation_backend.Migrations
{
    ...
    [Migration("20250818153543_edit-member-toAddCurrentSubscription")]
    partial class editmembertoAddCurrentSubscription
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("gym_reservation_backend.Models.MemberSubscription", b =>
                {
                    ...
                    b.HasOne("gym_reservation_backend.Models.Subscription", null)
                        .WithMany("MemberSubscriptions")
